//
//  ImageViewerCounterView.swift
//  major-7-ios
//
//  Created by jason on 4/12/2018.
...
class ImageViewerHelper {
    static func config() -> GalleryConfiguration {
        ...
        return [
            ...
            GalleryConfigurationItem.swipeToDismissThresholdVelocity(400),
